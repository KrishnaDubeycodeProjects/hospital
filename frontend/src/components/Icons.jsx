...
export function HospitalIcon({ size = 20, className = '' }) {
  return (
...
export function DoctorIcon({ size = 20, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M4.8 2.3A.3.3 0 0 0 4.5 2.6V5a3 3 0 0 0 6 0V2.6a.3.3 0 0 0-.3-.3h-5.4Z" />
      <path d="M10 5a2 2 0 0 0 4 0" />
      <path d="M14 2.6v2.4a3 3 0 0 0 6 0V2.6a.3.3 0 0 0-.3-.3h-5.4Z" />
...
export function QrCodeIcon({ size = 20, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
